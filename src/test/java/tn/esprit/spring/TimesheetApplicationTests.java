...
class TimesheetApplicationTests {
	...
	void testajouterEmploye(){
		...
		l.info("lancer  la methode testajouterEmployer()");		
	...
	void testaffecterEmployeADepartement(){
		l.info("lancer  la methode testaffecterEmployeADepartement()");		
		Employe employe =new Employe("arij", "mansour", "arijmansour@email.com","123ingenieur", true, Role.INGENIEUR);
		...
		l.debug( "employe "+employeId + "est affecter"+" a departement"+ depTelecomId);
	}

	@Transactional
	@Test
	void testdesaffecterEmployeADepartement(){
		l.info("lancer  la methode  testdesaffecterEmployeADepartement()");	
		Employe employe =new Employe("arij", "mansour", "arijmansour@email.com","123ingenieur", true, Role.INGENIEUR);
	...
	void testmettreAjourEmailByEmployeId(){	
		l.info("lancer  la methode lancer la methode  testmettreAjourEmailByEmployeId()");	
	...
	void testgetAllDepartements(){	
		l.info("lancer  la methode  testgetAllDepartements()");		
	...
	void testgetAllContrats(){
		l.info("lancer  la methode testgetAllContrats()");		
	...
	void testgetEntrepriseById() {
		l.info("lancer  la methode  testgetEntrepriseById()");		
	...
	void testajouterMission() {
		l.info("lancer  la methode  testajouterMission()");	
	...
	{
		l.info("lancer la methode testaffecterMissionADepartement()");
		Mission mission= new Mission("development web","spring application");
		Departement depTelecom = new Departement("Telecom");
		int depTelecomId = entrepriseControl.ajouterDepartement(depTelecom);
